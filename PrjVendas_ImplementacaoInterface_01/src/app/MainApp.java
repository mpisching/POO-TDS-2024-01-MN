...
public class MainApp {
    public static void main(String[] args)  {
        ...
        System.out.println("Estoque: " 
                + produto1.getEstoque().getQuantidade());
...
//                "343435533");
        ...
        Fornecedor fornecedor = internacional;//upcast - do subtipo para o supertipo
        ...
        //chamada de método usando polimorfismo
        mostrarDados(nacional);
        mostrarDados(fornecedor);
        
    }
    
//    private static void mostrarDados(Fornecedor fornecedor) {
//        System.out.println("Dados do fornecedor " + fornecedor.getClass().getSimpleName() +
//                ": \n");
//        System.out.println(fornecedor.getDados());
//    }
    
    private static void mostrarDados(IFornecedor fornecedor) {
        System.out.println("Dados do fornecedor " + fornecedor.getClass().getSimpleName() +
                ": \n");
        System.out.println(fornecedor.getDados());
