...
public class MainApp {
    public static void main(String[] args)  {
        ...
        p1.getEstoque().setSituacao(ESituacao.INATIVO);
        
        try {
            p1.getEstoque().repor(10000);
        } catch (Exception ex) {
        ...
        System.out.println("Nome: " + p1.getNome() 
               ...
               + "\nSituacao: " + p1.getEstoque().getSituacao().getDescricao()
               + "\nQtd Atual: " + p1.getEstoque().getQuantidade());
